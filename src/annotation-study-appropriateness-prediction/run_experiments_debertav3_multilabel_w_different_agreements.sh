...
#    do
#        export CUDA_VISIBLE_DEVICES=0
#        python /home/timongurcke/data-tmp/appropriateness-style-transfer/src/annotation-study-appropriateness-prediction/multilabel_debertav3.py --fold ${i} --repeat ${j} --output /home/timongurcke/data-tmp/appropriateness-style-transfer/data/models/multilabel-debertav3-conservative/fold${i} --input /home/timongurcke/data-tmp/appropriateness-style-transfer/data/appropriateness-corpus/appropriateness_corpus_conservative_w_folds.csv --issue
#    done
#done
...
do
    ...
    do
        export CUDA_VISIBLE_DEVICES=0
        python /home/timongurcke/data-tmp/appropriateness-style-transfer/src/annotation-study-appropriateness-prediction/multilabel_debertav3.py --fold ${i} --repeat ${j} --output /home/timongurcke/data-tmp/appropriateness-style-transfer/data/models/multilabel-debertav3-majority/fold${i} --input /home/timongurcke/data-tmp/appropriateness-style-transfer/data/appropriateness-corpus/appropriateness_corpus_majority_w_folds.csv --issue
    done
done
